...
const auth = require('../middlewares/profile.mw')
 ...
 */
router.get('/', commentController.getAllComments, auth.esAdmin)
 ...
 */
router.get('/:id', commentController.getCommentById, auth.esAdmin)
 ...
 */
router.post('/', commentController.newComment, auth.esAdmin)
 ...
 *               details: "El ID proporcionado no existe en la base de datos"
 */
router.patch('/:id', commentController.editCommentById, auth.esAdmin)
 ...
 *               details: "El ID proporcionado no existe en la base de datos"
 */
router.delete('/:id', commentController.deleteCommentById, auth.esAdmin)
