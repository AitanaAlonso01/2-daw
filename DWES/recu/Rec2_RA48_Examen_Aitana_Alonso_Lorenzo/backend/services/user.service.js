...
//Función creada para validar la contraseña (mayúsculas, minúsculas, 6 caracteres...)
...
exports.register = async (usernameParam, passwordParam) => {
  ...
  if (validatePasswordPolicy(passwordParam)) {
    ...
    return {
      err: 'Formato de contraseña no válido (mayúsculas, minúsculas y 6 caracteres)',
    } //En caso de que falle la validación de contraseña devolvemos un error indicando que NO se ha creado el usuario por problemas de validación
  }
}
